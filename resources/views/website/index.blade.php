                            ...
                            <div class="greennature-master-slider-item greennature-slider-item greennature-item" style="margin-bottom: 0px;">
                                ...
                                <div id="P_slider_1" class="master-slider-parent ms-parent-id-1">
                                    ...
                                    <div id="slider_1" class="master-slider ms-skin-default">
                                        ...
                                        <div class="ms-slide" data-delay="7" data-fill-mode="fill">
                                            <img src="plugins/masterslider/public/assets/css/blank.gif" alt="" title="" data-src="images/slider/slide2.jpg" />
                                        ...
                                        <div class="ms-slide" data-delay="7" data-fill-mode="fill">
                                            <img src="plugins/masterslider/public/assets/css/blank.gif" alt="" title="" data-src="images/slider/slide3.jpg" />
                                        ...
                                        <div class="ms-slide" data-delay="7" data-fill-mode="fill">
                                            <img src="plugins/masterslider/public/assets/css/blank.gif" alt="" title="" data-src="images/slider/slide4.jpg" />
                                    ...
                                    <div class="greennature-ux column-service-ux">
                                        <div class="greennature-item greennature-column-service-item greennature-type-2" style="margin-bottom: 0px;">
                                            ...
                                            <div class="column-service-content-wrapper">
                                                <h3 class="column-service-title">Innovative Solutions</h3>
                                                <div class="column-service-content greennature-skin-content">
                                                    <p>At the heart of Panaceu's operations is a robust portfolio of renewable energy solutions, including solar, wind, and hydroelectric power. Our cutting-edge technologies are designed to harness natural resources efficiently, providing reliable and affordable energy to homes, businesses, and communities. By leveraging the latest advancements in clean technology, Panaceu ensures that our solutions are not only environmentally friendly but also economically viable.</p>
                                ...
                                <div class="four columns">
                                    <div class="greennature-ux column-service-ux">
                                        <div class="greennature-item greennature-column-service-item greennature-type-2-bg" style="margin-bottom: 0px;background-color: #3f3221;">
                                            ...
                                            <div class="column-service-content-wrapper">
                                                <h3 class="column-service-title">Commitment to Sustainability</h3>
                                                <div class="column-service-content greennature-skin-content">
                                                    <p>Sustainability is not just a buzzword at Panaceu; it's a core value that drives everything we do. From our energy production methods to our corporate practices, we prioritize environmental stewardship and social responsibility. Panaceu is committed to minimizing waste, conserving water, and reducing greenhouse gas emissions across all our operations. We believe that a sustainable future is built on the foundation of clean energy, and we are proud to be at the forefront of this critical movement.</p>
                                                </div><a class="column-service-read-more" href="#">Learn More</a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="four columns">
                                    <div class="greennature-ux column-service-ux">
                                        <div class="greennature-item greennature-column-service-item greennature-type-2" style="margin-bottom: 0px;">
                                            ...
                                            <div class="column-service-content-wrapper">
                                                <h3 class="column-service-title">Community Engagement</h3>
                                                <div class="column-service-content greennature-skin-content">
                                                    <p>Panaceu understands that the journey towards a greener future involves the entire community. We actively engage with local stakeholders, governments, and educational institutions to promote awareness and understanding of renewable energy. Through partnerships and outreach programs, Panaceu is fostering a culture of sustainability and encouraging the adoption of clean energy practices.</p>
                                                </div><a class="column-service-read-more" href="#">Learn More</a></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="six columns">
                                    <div class="greennature-item greennature-action-ads-item" style="background: url('upload/donation-bg-1.jpg'); ">
                                        <h3 class="action-ads-title" style="color: #facc2e;">Panaceu Systems</h3>
                                        <div class="action-ads-caption greennature-skin-info">Leading the Charge in Green Energy</div>
                                ...
                                <div class="six columns">
                                    <div class="greennature-item greennature-action-ads-item" style="background: url('upload/donation-bg-2.jpg'); ">
                                        <h3 class="action-ads-title" style="color: #5dc269;">Future Vision</h3>
                                        <div class="action-ads-caption greennature-skin-info">Powering a Sustainable Future, One Innovation at a Time</div>
